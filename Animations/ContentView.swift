        ...
        NavigationView {
            List {
                ...
                Group {
                    Section(header:
                        HStack{
                            Text("Project 18 Layout and GeometryReader")
                            Spacer()
                            Image(systemName: "plus")
                        }.onTapGesture {
                            self.showingGeometry.toggle()
                        }
                    ) {
                        if self.showingGeometry {
                            Text("Layout and Geometry")
                                .font(.headline)
                            NavigationLink(destination: HowLayoutWorks()) {
                                Text("How layout works")
                            }
                            NavigationLink(destination: HowGeometryReaderWorks()) {
                                Text("ScrollView with GeometryReader")
                            }
